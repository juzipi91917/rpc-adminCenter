...
const (
	...
	PermissionService_ChangeAdminState_FullMethodName      = "/adminCenter.PermissionService/ChangeAdminState"
...
func (c *permissionServiceClient) ChangeAdminState(ctx context.Context, in *ChangeAdminStateRequest, opts ...grpc.CallOption) (*ChangeAdminStateResponse, error) {
	out := new(ChangeAdminStateResponse)
	err := c.cc.Invoke(ctx, PermissionService_ChangeAdminState_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PermissionServiceServer interface {
	...
	ChangeAdminState(context.Context, *ChangeAdminStateRequest) (*ChangeAdminStateResponse, error)
...
func (UnimplementedPermissionServiceServer) ChangeAdminState(context.Context, *ChangeAdminStateRequest) (*ChangeAdminStateResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ChangeAdminState not implemented")
}
...
func _PermissionService_ChangeAdminState_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ChangeAdminStateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PermissionServiceServer).ChangeAdminState(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PermissionService_ChangeAdminState_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PermissionServiceServer).ChangeAdminState(ctx, req.(*ChangeAdminStateRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PermissionService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ChangeAdminState",
			Handler:    _PermissionService_ChangeAdminState_Handler,
		},
		{
